...
if __name__ == '__main__':
    ...
    nv = ng.NetReverse(net_out_fldr=r'./data/input/net/cq', plain_prj='EPSG:32649', conn_buffer=0.6)
    l, n, group = nv.create_node_from_link(link_gdf=link_gdf,
                                           ...
                                           out_fldr=r'./data/input/net/cq')
    group.to_file('./data/input/net/cq/group.shp')

...
| 样例数据(基于深圳路网) | 有效的GPS点数 | top_k(k邻近候选参数) | gps_buffer(临域半径) | 候选路段条数 | 状态转移次数  | v0.2.1版解算时间 | v0.2.2版解算时间 |
|--------------|----------|----------------|------------------|-----------|------------|-------------|-----------|
| 深圳稀疏轨迹点样例1   | 190      | 60             | 500m             | 10615个 | 629788次 | 28秒         | **3.3秒**  |
| 深圳稀疏轨迹点样例2   | 400      | 20             | 120m             | 5137个  | 82006次  | 7.8秒        | **1.7秒**    |
